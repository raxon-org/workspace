/*! `raxon` grammar compiled for Highlight.js 11.10.0 */
  (function(){
  ...
  Description: raxon is a templating language for PHP
  Website: https://raxon.org
  Category: template
  */
  ...
  return raxon;
    ...
    hljs.registerLanguage('raxon', hljsGrammar);
  })();