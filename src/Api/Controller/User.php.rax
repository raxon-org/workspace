...
class User extends Controller {
     ...
     * @throws Exception
     */
    private static function token(App $object): null|Response
    {
     ...
     * @throws Exception
     */
    public static function login(App $object): null|Response
    {
     ...
     * @throws Exception
     */
    public static function current(App $object): null|Response
    {
     ...
     * @throws Exception
     */
    public static function refresh_token(App $object): null|Response
    {
        if (Handler::method() === 'GET') {
    ...
    public static function role_for_node(App $object, $role): object
    {
